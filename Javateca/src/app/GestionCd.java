...
public class GestionCd {
	...
	private JTextField codCDTField;
	...
	public JPanel gestion(Connection conn) {
		...
		try {
			...
			comboBoxBuscar.setModel(new DefaultComboBoxModel<Object>(new String[] {"Cod_CDROM", "Titulo", "Materia", "Autor", "Editorial", "Signatura"}));
			...
			lblNewLabel_1.setIcon(new ImageIcon(GestionCd.class.getResource("/resources/cd45.png")));
			
			JLabel lblNewLabel_2 = new JLabel("Gesti\u00F3n de CD-ROMs");
			lblNewLabel_2.setFont(new Font("DejaVu Sans", Font.PLAIN, 25));
			
			JLabel lblDetalles = new JLabel("Detalles");
			lblDetalles.setFont(new Font("DejaVu Sans", Font.PLAIN, 25));
			
			JLabel lblCodCD = new JLabel("Cod. CD-ROM");
			lblCodCD.setHorizontalAlignment(SwingConstants.TRAILING);
			
			codCDTField = new JTextField();
			codCDTField.setColumns(10);
			...
			avisoYaExiste = new JLabel("Cod.CD ya existe");
			avisoYaExiste.setForeground(Color.WHITE);
			...
			gl_contentPane.setHorizontalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGap(1)
						.addComponent(textFieldBusqueda, GroupLayout.DEFAULT_SIZE, 362, Short.MAX_VALUE)
						.addGap(10)
					...
					.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_contentPane.createSequentialGroup()
								.addComponent(lblCodCD, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
								.addGap(10)
								.addComponent(codCDTField, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(avisoYaExiste, GroupLayout.PREFERRED_SIZE, 87, GroupLayout.PREFERRED_SIZE)
								.addGap(24)
								.addComponent(lblTtulo, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
								.addGap(10)
								.addComponent(tituloTField, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
							.addGroup(gl_contentPane.createSequentialGroup()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(lblEditorial, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
										.addGap(10)
										.addComponent(editorialTField, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
									.addGroup(gl_contentPane.createSequentialGroup()
										.addComponent(lblSignatura, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
										.addGap(10)
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									.addGroup(gl_contentPane.createSequentialGroup()
										.addGap(3)
										.addComponent(lblCodCD))
									.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
										.addComponent(codCDTField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
			...
			tableDatos.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if ((fila > -1)) {
					   ...
					   codCDTField.setText((String)(modelo.getValueAt(fila,0)));
					   ...
					   codCDTField.setEditable(false);
					   codCDTField.setBackground(new Color(255,0,0));
			...
			codCDTField.addKeyListener(new KeyAdapter() {
				@Override
				public void keyReleased(KeyEvent arg0) {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if(btnNuevoMod.getText().equals("Nuevo")) {
						...
						if(ConBD.ejecutarUpdateSQL(conn, sql)) {
							...
							Object frame = null;
							JOptionPane.showMessageDialog((Component) frame,
								    "El CD-ROM con COD_CDROM '"+codCDTField.getText()+"' no se ha creado correctamente.","Error",JOptionPane.ERROR_MESSAGE);
						...
						if(ConBD.ejecutarUpdateSQL(conn, sql)) {
							...
							JOptionPane.showMessageDialog((Component) frame,
								    "CD-ROM con COD_CDROM '"+codCDTField.getText()+"' modificado correctamente.","Modificación correcta",JOptionPane.DEFAULT_OPTION);
							...
							Object frame = null;
							JOptionPane.showMessageDialog((Component) frame,
								    "El CD-ROM con COD_CDROM '"+codCDTField.getText()+"' no se ha modificado correctamente.","Error",JOptionPane.ERROR_MESSAGE);
			...
			btnEliminar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if(ConBD.ejecutarUpdateSQL(conn, sql)) {
						...
						Object frame = null;
						JOptionPane.showMessageDialog((Component) frame,
							    "El CD-ROM con COD_CDROM '"+codCDTField.getText()+"' no se ha eliminado correctamente.","Error",JOptionPane.ERROR_MESSAGE);
